...
### Download the latest PocketMine-MP.phar build on [GitHub Actions artifacts](https://github.com/KygekDev/PMMP-IPv6/actions?query=branch%3Astable+is%3Asuccess).
